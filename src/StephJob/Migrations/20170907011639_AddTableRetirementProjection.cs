...
{
    public partial class AddTableRetirementProjection : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RetirementProjectionId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RetirementProjections", x => x.RetirementProjectionId);
                });
        }
